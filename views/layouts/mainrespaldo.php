    ...
    <?php $this->endBody() ?>
      ...
      <script type="text/javascript">
            ...
            function deleteItemAl(id){
             ...
             function deleteItemEnt(id,$quantity,idp){


                updateCartEnt(id,$quantity,idp);
           ...
           $.get('<?= Yii::$app->homeUrl ?>/almacen/shopping-cart/add', {'id': id}, function(data){
            ...
            swal("Salida!", "Salida Eliminado!", "success");
              ...
              function delItemEnt(id,id_salida,cantidad){

            if(confirm('Estas seguro de eliminar?')){

            $.get('<?= Yii::$app->homeUrl ?>/almacen/al-entrada-detalle/borrar', {'id': id, 'id_salida': id_salida, 'cantidad': cantidad}, function(data){
            swal("Entrada!", "Entrada Eliminada!", "success");
             ...
             function delItemAl2(id,id_salida,cantidad){

            if(confirm('Estas seguro de eliminar?')){

            $.get('<?= Yii::$app->homeUrl ?>/almacen/al-salida-detalle/borrar2', {'id': id, 'id_salida': id_salida, 'cantidad': cantidad}, function(data){
