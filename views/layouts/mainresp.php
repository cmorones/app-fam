...
if (Yii::$app->controller->action->id === 'login') {
    ...
    <?php $this->endBody() ?>
      ...
      <script type="text/javascript">
            ...
            function deleteItem(id,cantidad,descuento,tipo){


                updateCart(id,tipo,descuento,tipo);
                swal("Producto!", "Producto Eliminado del carrito!", "error");
            }
            ...
            function updateCart(id,quantity,descuento,tipo){

                 $.get('<?= Yii::$app->homeUrl ?>/ventas/shopping-cart/add2', {'id': id, 'quantity': quantity, 'descuento': descuento, 'tipo': tipo}, function(data){
