...
$resultado = \Yii::$app->db->createCommand('select distinct al_entradas.id_periodo as periodo, cat_anos.nombre from al_entradas,cat_anos where al_entradas.id_periodo=cat_anos.id')->queryAll();


foreach ($resultado as $value) {

	 $query = 'SELECT count(fecha)  FROM al_entradas where id_periodo ='.$value['periodo'];
