            ...
            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="cant1[<?=$value->id?>]" value="<?=$value->cantidad?>" ></td>
                                                         ...
                                                         <td><input type="text" name="cant2[<?=$value->id?>]" value="<?=$value->cantidad_sol?>""  class="group1"></td>
                                                         <td><input type="text" name="cant3[<?=$value->id?>]" value="<?=$value->cantidad_aut?>""  class="group1"></td>
