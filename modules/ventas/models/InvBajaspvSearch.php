...
/**
 * InvBajaspvSearch represents the model behind the search form about `app\modules\ventas\models\InvBajaspv`.
 */
class InvBajaspvSearch extends InvBajaspv
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['fecha_reg', 'motivo', 'created_at', 'updated_at'], 'safe'],
        ];
    }
