...
/**
 * CancelacionesSearch represents the model behind the search form about `app\modules\ventas\models\Cancelaciones`.
 */
class CancelacionesSearch extends Cancelaciones
{
    ...
    {
        return [
            [['id', 'id_orden', 'created_by', 'updated_by'], 'integer'],
